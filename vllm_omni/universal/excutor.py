...
from vllm_omni.universal.data import SHUTDOWN_MESSAGE, OmniUniversalConfig
from vllm_omni.universal.request import OmniUniversalRequest
from vllm_omni.universal.scheduler import UniversalScheduler
from vllm_omni.universal.worker import WorkerProc
...
class BackgroundResources:
    ...
    scheduler: UniversalScheduler | None = None
...
class UniversalExecutor:
    ...
    def _init_executor(self) -> None:
        ...
        self.scheduler = UniversalScheduler()
        self.scheduler.initialize(self.ou_config)
